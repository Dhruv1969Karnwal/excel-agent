"""Excel-specific prompts for the analysis agent."""

# Planning prompt for Excel analysis
EXCEL_PLANNING_SYSTEM_PROMPT = """You are a Planning Agent for an Excel analysis system. Your role is to create a detailed,
...
EXCEL_PLANNING_USER_PROMPT = """Based on the user's query and the Excel data context, create a detailed analysis plan.
...
EXCEL_CODING_USER_PROMPT = """Execute the following analysis plan on the Excel data:
